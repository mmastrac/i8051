...
build-asm NAME:
    ...
    @sdas8051 -o {{ASM_BUILD_DIR}}/{{NAME}}/{{NAME}}.rel tests/asm/{{NAME}}.asm
    @sdas8051 -l {{ASM_BUILD_DIR}}/{{NAME}}/{{NAME}}.lst tests/asm/{{NAME}}.asm
    @sdas8051 -s {{ASM_BUILD_DIR}}/{{NAME}}/{{NAME}}.sym tests/asm/{{NAME}}.asm
    sdcc -mmcs51 --code-size 8192 -o {{ASM_BUILD_DIR}}/{{NAME}}/{{NAME}} {{ASM_BUILD_DIR}}/{{NAME}}/{{NAME}}.rel
    sdobjcopy -I ihex -O binary {{ASM_BUILD_DIR}}/{{NAME}}/{{NAME}} {{ASM_OUTPUT_DIR}}/asm/{{NAME}}.bin
